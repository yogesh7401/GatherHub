...
export default function FormFeild({
  ...
  return (
    <div
      ref={questionRef}
      className={`border-2 rounded-lg p-5 mb-5 relative ${isActive ? 'border-blue-400' : ''}`}
    >
      {isActive ? (
        <div>
          <div className="flex gap-5 justify-between mr-10">
            ...
            <div>
              <label htmlFor="Type">Input type</label> <br />
              <Select
                className="InputType"
        ...
        <div className="cursor-pointer">
          <div className="flex gap-10 justify-between mr-20">
            <div>
              <p className="required text-gray-600 mb-1" htmlFor="label">
                Label
              </p>
              <p>{question.label}</p>
            </div>
            <div>
              <p className="text-gray-600 mb-1" htmlFor="label">
                Input type
              </p>
              <p>Text Input</p>
            </div>
